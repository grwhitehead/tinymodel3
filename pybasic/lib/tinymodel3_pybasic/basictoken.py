...
class BASICToken:
        ...
        CLS             = 90  # CLS keyword
        SET             = 91  # SET keyword
        RESET           = 92  # RESET keyword
        POINT           = 93  # POINT keyword
        PEEK            = 94  # PEEK keyword
        POKE            = 95  # POKE keyword
        ...
        keywords = {'LET': LET, 'LIST': LIST, 'PRINT': PRINT,
                    ...
                    'CLS':CLS, 'SET':SET, 'RESET':RESET, 'POINT':POINT, 'PEEK':PEEK, 'POKE':POKE}
